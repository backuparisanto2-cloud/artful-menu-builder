...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kantin Inyong" },
      { name: "description", content: "Menu digital Umaeh Inyong Purwokerto." },
      { name: "author", content: "Kantin Inyong" },
      { property: "og:title", content: "Kantin Inyong" },
      { property: "og:description", content: "Menu digital Umaeh Inyong Purwokerto." },
